...
window.FEATURES = {
  ...
  rest: {
    en: [
      ...
      ["Time zones, offline", "<code>tokyo time</code> or <code>3pm pst to beijing</code>, with daylight saving time handled. <code>tokyo</code> alone is still a normal search."],
    ...
    zh: [
      ...
      ["时区换算，离线可用", "<code>东京时间</code> 或 <code>3pm pst to beijing</code>，夏令时自动计算。单独输入 <code>tokyo</code> 仍按普通搜索处理。"],
