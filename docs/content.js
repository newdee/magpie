...
window.FEATURES = {
  ...
  rest: {
    en: [
      ...
      ["Look up what you selected", "A second shortcut copies the selection in whatever app you are in and summons magpie with it as the query."],
    ...
    zh: [
      ...
      ["划词搜索", "第二个快捷键：在任何应用里选中文字后按一下，magpie 复制选区并带着它弹出来。"],
